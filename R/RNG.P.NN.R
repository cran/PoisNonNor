RNG_P_NN <- function(lamvec=NULL, cmat, rmat=NULL, norow, mean.vec = NULL, variance.vec = NULL) {
  .Deprecated("RNG.P.NN") #include a package argument, too
  RNG.P.NN(lamvec=NULL, cmat, rmat=NULL, norow, mean.vec = NULL, variance.vec = NULL)
}
